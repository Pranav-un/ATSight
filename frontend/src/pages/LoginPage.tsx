      ...
      <div className="max-w-md w-full">
        ...
        >
          <p className="text-sm text-dark-600">
            <span className="font-medium">Job Seekers:</span> Analyze and improve your resume<br />
            <span className="font-medium">Recruiters:</span> Bulk analyze and rank candidates
          </p>
        </motion.div>
      </div>
    </div>
